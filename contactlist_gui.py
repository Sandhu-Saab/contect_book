...
def load_gui(app):
    ...
    tk.Entry(app.container, text=app.text_first_name, width=50)\
        .grid(row=1, column=0)

    tk.Label(app.container, text="Last Name") \
        .grid(row=2, column=0, sticky=W)

    tk.Entry(app.container, text=app.text_last_name, width=50) \
        .grid(row=3, column=0)

    tk.Label(app.container, text="Email")\
        .grid(row=4, column=0, sticky=W)

    tk.Entry(app.container, text=app.text_email, width=50)\
        .grid(row=5, column=0)

    tk.Label(app.container, text="Phone Number") \
        .grid(row=6, column=0, sticky=W)

    tk.Entry(app.container, text=app.text_phone_number, width=50) \
        .grid(row=7, column=0)

    tk.Label(app.container, text="Address") \
        .grid(row=8, column=0, sticky=W)

    tk.Entry(app.container, text=app.text_address, width=50) \
        .grid(row=9, column=0)
